...
impl Mesh {
    ...
    pub fn setup(&mut self, pos_a: GLuint, color_a: GLuint, model_inst_a: GLuint) {
        println!(
            "mesh: {}: setup: pos_a: {}, color_a: {}, model_inst_a: {}",
            self.name, pos_a, color_a, model_inst_a
        );
        ...
        unsafe {
            ...
            gl::BufferData(
                gl::ARRAY_BUFFER,
                (self.vertices.len() * mem::size_of::<f32>()) as GLsizeiptr,
            ...
            gl::BufferData(
                ...
                (self.elements.len() * mem::size_of::<f32>()) as GLsizeiptr,
                mem::transmute(&self.elements[0]),
                gl::STATIC_DRAW,
            );
            ...
            gl::VertexAttribPointer(
                ...
                gl::FLOAT,
                gl::FALSE,
                (self.vertex_size * mem::size_of::<f32>()) as GLint,
                ptr::null(),
            );
    ...
    pub fn update_inst(&mut self, model_inst: &Vec<Matrix4<f32>>) {
        unsafe {
            ...
            gl::BufferData(
                gl::ARRAY_BUFFER,
                model_inst_size as GLsizeiptr,
                mem::transmute(&model_inst[0]),
                gl::STREAM_DRAW,
            );
